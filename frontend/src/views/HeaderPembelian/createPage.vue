  ...
  export default {
    setup() {
      ...
      function store() {
        ...
        let status = pembelian.status
        axios
          .post("http://149.28.137.82/api/headers", {
            tgl: tgl,
