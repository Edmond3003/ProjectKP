...
export default {
  setup() {
    ...
    onMounted(() => {
        axios
        .get("http://149.28.137.82/api/laporanByTglBarangJual", {
          params: {
      ...
      function cetakPDF() {
        ...
        const headerContent = `
          <div style="text-align: center;">
            <h1>Laporan Keluar Per Tanggal & ATK</h1>
        ...
        const tableContent = `
        <table border="1" style="border-collapse: collapse; width: 100%; text-align: left; border: 2px solid #000;">
          <thead>
            <tr>
          ...
          <tbody>
            ${dataLaporan.value.map(laporan => `
              <tr style="border: 1px solid #000;">
                <td style="padding: 8px; border: 1px solid #000;">${laporan.cabang}</td>
